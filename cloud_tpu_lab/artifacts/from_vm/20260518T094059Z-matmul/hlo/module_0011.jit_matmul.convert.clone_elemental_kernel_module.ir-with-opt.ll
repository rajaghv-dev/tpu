...
@convert.clone_parallel_bounds = private unnamed_addr constant [5 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 102]], [1 x [2 x i64]] [[2 x i64] [i64 102, i64 204]], [1 x [2 x i64]] [[2 x i64] [i64 204, i64 306]], [1 x [2 x i64]] [[2 x i64] [i64 306, i64 408]], [1 x [2 x i64]] [[2 x i64] [i64 408, i64 512]]]

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define noalias noundef ptr @convert.clone_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [5 x [1 x [2 x i64]]], ptr @convert.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 0
  %up_dim_0_gep = getelementptr inbounds [5 x [1 x [2 x i64]]], ptr @convert.clone_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
...
vector.ph:                                        ; preds = %1, %convert.clone.loop_exit.dim.1
  %convert.clone.invar_address.dim.0.06 = phi i64 [ %invar.inc, %convert.clone.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next.3, %vector.body ]
  %2 = getelementptr inbounds [512 x [512 x bfloat]], ptr %arg0, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index
  ...
  %14 = getelementptr inbounds [512 x [512 x float]], ptr %arg1, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index
  ...
  %18 = getelementptr inbounds [512 x [512 x bfloat]], ptr %arg0, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next
  ...
  %30 = getelementptr inbounds [512 x [512 x float]], ptr %arg1, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next
  ...
  %34 = getelementptr inbounds [512 x [512 x bfloat]], ptr %arg0, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next.1
  ...
  %46 = getelementptr inbounds [512 x [512 x float]], ptr %arg1, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next.1
  ...
  %50 = getelementptr inbounds [512 x [512 x bfloat]], ptr %arg0, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next.2
  ...
  %62 = getelementptr inbounds [512 x [512 x float]], ptr %arg1, i64 0, i64 %convert.clone.invar_address.dim.0.06, i64 %index.next.2
  ...
  br i1 %66, label %convert.clone.loop_exit.dim.1, label %vector.body, !llvm.loop !8

convert.clone.loop_exit.dim.1:                    ; preds = %vector.body
  %invar.inc = add nuw nsw i64 %convert.clone.invar_address.dim.0.06, 1
  %exitcond7.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond7.not, label %return, label %vector.ph, !llvm.loop !11

return:                                           ; preds = %convert.clone.loop_exit.dim.1, %1
  ret ptr null
}
