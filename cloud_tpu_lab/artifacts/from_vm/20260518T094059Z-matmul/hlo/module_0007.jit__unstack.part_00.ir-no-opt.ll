...
define ptr @slice_bitcast_fusion.1(ptr %0) #0 {
  %slice_bitcast_fusion.1.invar_address.dim.0 = alloca i64, align 8
  ...
  store i64 0, ptr %slice_bitcast_fusion.1.invar_address.dim.0, align 4
  br label %slice_bitcast_fusion.1.loop_header.dim.0

slice_bitcast_fusion.1.loop_header.dim.0:         ; preds = %slice_bitcast_fusion.1.loop_body.dim.0, %1
  %slice_bitcast_fusion.1.indvar.dim.0 = load i64, ptr %slice_bitcast_fusion.1.invar_address.dim.0, align 4
  %2 = icmp uge i64 %slice_bitcast_fusion.1.indvar.dim.0, 2
  br i1 %2, label %slice_bitcast_fusion.1.loop_exit.dim.0, label %slice_bitcast_fusion.1.loop_body.dim.0

slice_bitcast_fusion.1.loop_body.dim.0:           ; preds = %slice_bitcast_fusion.1.loop_header.dim.0
  %3 = add i64 %slice_bitcast_fusion.1.indvar.dim.0, 0
  %4 = getelementptr inbounds [2 x [2 x i32]], ptr %arg0, i64 0, i64 0, i64 %3
  %5 = load i32, ptr %4, align 4, !invariant.load !1, !noalias !5
  %6 = getelementptr inbounds [2 x i32], ptr %arg1, i64 0, i64 %slice_bitcast_fusion.1.indvar.dim.0
  store i32 %5, ptr %6, align 4, !alias.scope !5
  %invar.inc = add nuw nsw i64 %slice_bitcast_fusion.1.indvar.dim.0, 1
  store i64 %invar.inc, ptr %slice_bitcast_fusion.1.invar_address.dim.0, align 4
  br label %slice_bitcast_fusion.1.loop_header.dim.0

slice_bitcast_fusion.1.loop_exit.dim.0:           ; preds = %slice_bitcast_fusion.1.loop_header.dim.0
  br label %return

return:                                           ; preds = %slice_bitcast_fusion.1.loop_exit.dim.0
  ret ptr null
}
...
!4 = !{i64 8}
!5 = !{!6}
!6 = !{!"result slice: {index:2, offset:0, size:8}", !7}
